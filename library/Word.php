...
class Word {	
	...
	*/
	...
	//6 условие доделать текста
		...
		$data['formula_Nt_stvB-var2'] = $data['formula_water-consumption-var2'] / $data['formula_q_stvB-var2'];
		//$data['formula_Nt_stvB_round'] = round($data['formula_Nt_stvB'],2)
	...
	//13
		...
		$data['formula_Lpr-var2'] = ($data['formula_Hh-var2'] - ( $data['formula_Hp-var2']+$data['formula_Zm-var2']+$data['formula_Zst-var2']))*20/($data['formula_S-var2']*$data['formula_Q-var2']*$data['formula_Q-var2']);
